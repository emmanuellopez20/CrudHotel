...
class pestanaClientes(ttk.Frame):
    def __init__(self, notebook, clientes):
        ...
        self.btSalvar = tk.Button(self.frameBotones, text="Salvar", font=("Arial", 10), command=self.salvar_cliente)
        self.btSalvar.grid(row=1, column=2, padx=10, pady=10)

        self.btCancelar = tk.Button(self.frameBotones, text="Cancelar", font=("Arial", 10), command=self.cancelar)
        self.btCancelar.grid(row=1, column=3, padx=10, pady=10)

        self.btEditar = tk.Button(self.frameBotones, text="Editar", font=("Arial", 10), command=self.editar_cliente)
        self.btEditar.grid(row=1, column=4, padx=10, pady=10)

        self.btEliminar = tk.Button(self.frameBotones, text="Eliminar", font=("Arial", 10), command=self.eliminar_cliente)
...
class pestanaReservaciones(ttk.Frame):
    def __init__(self, notebook, reservaciones, clientes, habitaciones):
        ...
        self.btSalvar = tk.Button(self.frameBotones, text="Reservar", font=("Arial", 10), command=self.salvar_reservacion)
        self.btSalvar.grid(row=5, column=2, padx=10, pady=10)

        self.btCancelar = tk.Button(self.frameBotones, text="Cancelar Reservacion", font=("Arial", 10), command=self.cancelar_reservacion)
        self.btCancelar.grid(row=5, column=3, padx=10, pady=10)

        self.btEditar = tk.Button(self.frameBotones, text="Editar", font=("Arial", 10), command=self.editar_reservacion)
...
class PestanaHabitaciones(ttk.Frame):
    def __init__(self, notebook, habitaciones):
        ...
        self.btEditar = tk.Button(self.frameBotones, text="Editar", font=("Arial", 10), command=self.editar_habitacion)
